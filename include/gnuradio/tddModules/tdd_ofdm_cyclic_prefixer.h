...
#ifndef INCLUDED_TDDMODULES_TDD_OFDM_CYCLIC_PREFIXER_H
#define INCLUDED_TDDMODULES_TDD_OFDM_CYCLIC_PREFIXER_H
 ...
 *
 */
class TDDMODULES_API tdd_ofdm_cyclic_prefixer
    : virtual public gr::tagged_stream_block {
public:
  typedef std::shared_ptr<tdd_ofdm_cyclic_prefixer> sptr;
...
#endif /* INCLUDED_TDDMODULES_TDD_OFDM_CYCLIC_PREFIXER_H */
