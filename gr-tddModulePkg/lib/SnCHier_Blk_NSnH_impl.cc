 ...
 */
 ...
 #include "SnCHier_Blk_NSnH_impl.h"
 ...
 SnCHier_Blk_NSnH::sptr
 SnCHier_Blk_NSnH::make(int fft_len, int cp_len, bool use_even_carriers)
 {
     return gnuradio::make_block_sptr<SnCHier_Blk_NSnH_impl>(
  ...
  */
 SnCHier_Blk_NSnH_impl::SnCHier_Blk_NSnH_impl(int fft_len,
                                              int cp_len,
                                              bool use_even_carriers)
     : gr::hier_block2("SnCHier_Blk_NSnH",
                       gr::io_signature::make(
                           1 , 1 , sizeof(gr_complex)),
                       gr::io_signature::make3(
                           1, 3, sizeof(float), sizeof(unsigned char),
                           sizeof(float)))
 {
     ...
     gr::blocks::plateau_detector_fb::sptr plateau_detector(
         gr::blocks::plateau_detector_fb::make(cp_len, 0.9));
  ...
  */
 SnCHier_Blk_NSnH_impl::~SnCHier_Blk_NSnH_impl() {}
