...
#include "tddTaggedStreamMux_impl.h"
#include <gnuradio/io_signature.h>

namespace gr {
namespace tddModulePkg {

tddTaggedStreamMux::sptr tddTaggedStreamMux::make(size_t itemsize,
                                                  const std::string& lengthtagname,
                                                  unsigned int tag_preserve_head_pos,
                                                  unsigned int header_len)
{
    return gnuradio::make_block_sptr<tddTaggedStreamMux_impl>(
 ...
 */
tddTaggedStreamMux_impl::tddTaggedStreamMux_impl(size_t itemsize,
                                                 const std::string& lengthtagname,
                                                 unsigned int tag_preserve_head_pos,
                                                 unsigned int header_len)
    : gr::tagged_stream_block("tddTaggedStreamMux",
 ...
 */
tddTaggedStreamMux_impl::~tddTaggedStreamMux_impl() {}

int tddTaggedStreamMux_impl::calculate_output_stream_length(const gr_vector_int &ninput_items) {
    int nout = 0;
...
int tddTaggedStreamMux_impl::work(int noutput_items,
