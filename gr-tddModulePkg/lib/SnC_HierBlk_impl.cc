 ...
 */
 ...
 SnC_HierBlk::sptr
 SnC_HierBlk::make(int fft_len, int cp_len, bool use_even_carriers, float threshold)
 {
     return gnuradio::make_block_sptr<SnC_HierBlk_impl>(
  ...
  */
 SnC_HierBlk_impl::SnC_HierBlk_impl(int fft_len,
                                    int cp_len,
                                    bool use_even_carriers,
                                    float threshold)
     : gr::hier_block2("SnC_HierBlk",
  ...
  */
 SnC_HierBlk_impl::~SnC_HierBlk_impl() {}
