...
#include "tddOFDMCyclicPrefix_impl.h"
#include <gnuradio/io_signature.h>

namespace gr {
namespace tddModulePkg {

tddOFDMCyclicPrefix::sptr tddOFDMCyclicPrefix::make(int fft_len,
                                                    const std::vector<int>& cp_lengths,
                                                    int rolloff_len,
                                                    const std::string& len_tag_key)
{
    return gnuradio::make_block_sptr<tddOFDMCyclicPrefix_impl>(
 ...
 */
tddOFDMCyclicPrefix_impl::tddOFDMCyclicPrefix_impl(int fft_len,
                                                   const std::vector<int>& cp_lengths,
                                                   int rolloff_len,
                                                   const std::string& len_tag_key)
 ...
 */
tddOFDMCyclicPrefix_impl::~tddOFDMCyclicPrefix_impl() {}

int tddOFDMCyclicPrefix_impl::calculate_output_stream_length(
...
int tddOFDMCyclicPrefix_impl::work(int noutput_items,
