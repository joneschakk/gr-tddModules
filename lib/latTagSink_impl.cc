...
latTagSink::sptr latTagSink::make(size_t item_size)
{
    return gnuradio::make_block_sptr<latTagSink_impl>(item_size);
}
 ...
 */
latTagSink_impl::latTagSink_impl(size_t item_size)
