...
#ifndef INCLUDED_TDDMODULES_TDD_OFDM_CYCLIC_PREFIXER_IMPL_H
#define INCLUDED_TDDMODULES_TDD_OFDM_CYCLIC_PREFIXER_IMPL_H
...
class tdd_ofdm_cyclic_prefixer_impl : public tdd_ofdm_cyclic_prefixer {
private:
   //! FFT length
   int d_fft_len;
...
public:
  tdd_ofdm_cyclic_prefixer_impl(int fft_len,
                                const std::vector<int>& cp_lengths,
                                int rolloff_len,
                                const std::string& len_tag_key);
  ~tdd_ofdm_cyclic_prefixer_impl();
...
#endif /* INCLUDED_TDDMODULES_TDD_OFDM_CYCLIC_PREFIXER_IMPL_H */
