...
#include "tdd_ofdm_cyclic_prefixer_impl.h"
...
//  tdd_ofdm_cyclic_prefixer::sptr tdd_ofdm_cyclic_prefixer::make(size_t input_size,
//                                                        size_t output_size,
//                                                        int rolloff_len,
...
//      return gnuradio::make_block_sptr<tdd_ofdm_cyclic_prefixer_impl>(
//          fft_len, cp_lengths, rolloff_len, len_tag_key);
//  }
 
 tdd_ofdm_cyclic_prefixer::sptr tdd_ofdm_cyclic_prefixer::make(int fft_len,
 ...
 tdd_ofdm_cyclic_prefixer_impl::tdd_ofdm_cyclic_prefixer_impl(int fft_len,
                                                      const std::vector<int>& cp_lengths,
                                                      int rolloff_len,
                                                      const std::string& len_tag_key)
     : gr::tagged_stream_block("tdd_ofdm_cyclic_prefixer",
 ...
 tdd_ofdm_cyclic_prefixer_impl::~tdd_ofdm_cyclic_prefixer_impl() {}
 
 int tdd_ofdm_cyclic_prefixer_impl::calculate_output_stream_length(
 ...
 int tdd_ofdm_cyclic_prefixer_impl::work(int noutput_items,
