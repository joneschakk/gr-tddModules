...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile="./input.txt"):
        ...
        self.tddModules_tdd_ofdm_cyclic_prefixer_0 = tddModules.tdd_ofdm_cyclic_prefixer(
            ...
            rolloff,
            "frame_len")
        self.tddModules_tddTagStreamMux_0 = tddModules.tddTagStreamMux(gr.sizeof_gr_complex*1, "frame_len", 0)
        self.tddModules_randomSrcTdd_0 = tddModules.randomSrcTdd(0.03, 5000000)
        self.tddModules_msgStrobeTddRx_0 = tddModules.msgStrobeTddRx(35, 5)
